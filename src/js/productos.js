function abrirModalEditar(id) {
    ...
    document.getElementById('editar_precio_venta').value = articulo.precio_venta_neto.replace("$", "").trim();
    document.getElementById('editar_precio_venta_formateado').textContent = articulo.precio_venta_neto.replace("$", "").trim();
